...
.auth-btn{width:100%;background:var(--acc2);border:1px solid var(--acc);border-radius:6px;padding:10px;color:var(--acc-fg,#fff);font-size:14px;font-weight:500;cursor:pointer;font-family:'Inter',sans-serif;transition:background .1s}
