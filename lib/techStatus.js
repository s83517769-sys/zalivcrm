...
export const TECH_STATUS_MAP = {
  ...
  // Чисто клиентская группа сайдбара главной (pages/index.js): забаненный
  // аккаунт без спенда сегодня/вчера. effectiveTechStatus её НЕ возвращает —
  // в снимки daily_tech_status и в /stats не утекает.
  'Удалить':        { l:'Удалить',        c:'#4b5563' },
}
